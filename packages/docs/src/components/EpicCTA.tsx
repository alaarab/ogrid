...
const frameworkCards = [
  ...
  {
    name: 'Angular',
    detail: 'Material · PrimeNG · Radix',
    pkg: '@alaarab/ogrid-angular-material',
    color: '#dd0031',
    bg: 'rgba(221, 0, 49, 0.08)',
    border: 'rgba(221, 0, 49, 0.3)',
    glow: 'rgba(221, 0, 49, 0.22)',
  },
  {
    name: 'Vue',
    detail: 'Vuetify · PrimeVue · Radix',
    pkg: '@alaarab/ogrid-vue-vuetify',
    color: '#42b883',
    bg: 'rgba(66, 184, 131, 0.08)',
    border: 'rgba(66, 184, 131, 0.3)',
    glow: 'rgba(66, 184, 131, 0.22)',
  },
  {
    name: 'Vanilla JS',
