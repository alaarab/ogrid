...
function MaterialGrid() {
  const {
    OGrid,
    useUndoRedo,
  } = require('@alaarab/ogrid-react-material') as typeof import('@alaarab/ogrid-react-material');
  const {
    ThemeProvider,
    createTheme,
  } = require('@mui/material/styles') as typeof import('@mui/material/styles');
  ...
  return (
    <ThemeProvider theme={theme}>
      <OGrid<Person>
        ...
        canUndo={canUndo}
        canRedo={canRedo}
        aria-label="Material UI showcase grid"
      />
    </ThemeProvider>
  );
}
