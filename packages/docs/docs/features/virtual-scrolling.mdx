...
|-------|------|---------|-------------|
| `enabled` | `boolean` | `false` | Enable virtual scrolling. Must be set to `true` to activate. |
| `rowHeight` | `number` | `36` | Fixed height of each row in pixels. Required when enabled. |
