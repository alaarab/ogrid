...
import type { IDataSource, IFetchParams, IPageResult } from '@alaarab/ogrid-react-fluent';
...
import type { IDataSource, IFetchParams, IPageResult } from '@alaarab/ogrid-react-material';
