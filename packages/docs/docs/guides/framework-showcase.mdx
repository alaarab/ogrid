...
## Premium Inputs (Optional Add-ons)

All frameworks have optional premium input packages with advanced cell editors like the calendar-based `DatePickerEditor`. These are tree-shakeable and have **zero bundle impact** when not installed.

| Framework | Package | Install |
|-----------|---------|---------|
| React | `@alaarab/ogrid-react-inputs` | `npm install @alaarab/ogrid-react-inputs` |
| Angular | `@alaarab/ogrid-angular-inputs` | `npm install @alaarab/ogrid-angular-inputs` |
| Vue | `@alaarab/ogrid-vue-inputs` | `npm install @alaarab/ogrid-vue-inputs` |
| Vanilla JS | `@alaarab/ogrid-js-inputs` | `npm install @alaarab/ogrid-js-inputs` |

See the [Premium Inputs](../features/premium-inputs) feature page for usage examples and the full list of available editors.
...
- [Premium Inputs](../features/premium-inputs) — optional advanced cell editors
