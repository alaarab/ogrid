...
For Angular v21 projects using Angular Material. Requires `@angular/core`, `@angular/common`, `@angular/material`, and `@angular/cdk` as peer dependencies.
...
For Angular v21 projects using PrimeNG. Requires `@angular/core`, `@angular/common`, and `primeng` as peer dependencies.
...
For Vue 3 projects using Vuetify. Requires `vue` and `vuetify` as peer dependencies.
...
For Vue 3 projects using PrimeVue. Requires `vue` and `primevue` as peer dependencies.
...
For projects without a framework. Class-based API with EventEmitter state management.
