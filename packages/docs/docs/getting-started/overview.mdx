...
flowchart TD
  subgraph ui [" "]
    ...
    material("<b>@alaarab/ogrid-material</b><br/><small>MUI v6</small>")
  end
...
| `@alaarab/ogrid-material` | MUI v6 | Material Design apps, dashboards |
...
| `@alaarab/ogrid-material` | [![npm](https://img.shields.io/npm/v/@alaarab/ogrid-material)](https://npmjs.com/package/@alaarab/ogrid-material) | Material UI v6 implementation |
...
- Quick start guides for [Radix](./quick-start-radix), [Fluent UI](./quick-start-fluent), or [Material UI](./quick-start-material)
