...
| `dataSource` | `IDataSource<T>` | `undefined` | Server-side data source. Mutually exclusive with `data`. See [Data Source](./data-source). |
...
| `defaultPageSize` | `number` | `10` | Initial page size in uncontrolled mode. |
...
| `title` | `ReactNode` | `undefined` | Title rendered above the grid. |
| `toolbar` | `ReactNode` | `undefined` | Custom toolbar content rendered in the grid header area. |
