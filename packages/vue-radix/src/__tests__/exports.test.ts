// Vue SFC components (.vue files) are loaded via jest-mocks/vue-component.cjs.js,
// which returns { default: {} }. So component exports will be {} objects rather than
// full Vue component definitions. This is sufficient to verify the export surface.
describe('@alaarab/ogrid-vue-radix exports', () => {
